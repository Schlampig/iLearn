...
# File settings
flags.DEFINE_string("bert_config_file", p_bert_config_file,
                    "The config json file corresponding to the pre-trained BERT model. ")
flags.DEFINE_string("vocab_file", p_vocab_file, "The vocabulary file that the BERT model was trained on.")
flags.DEFINE_string("output_dir", p_output_dir, "The output directory where the model checkpoints will be written.")
...
flags.DEFINE_integer("n_best_size", 20, "n-best predictions.")
...
flags.DEFINE_float("null_score_diff_threshold", 0.0, "If null_score - best_non_null > threshold predict null.")
...
def validate_flags_or_throw(bert_config):
    ...
    if FLAGS.max_seq_length > bert_config.max_position_embeddings:
        raise ValueError("Cannot use sequence length %d because the BERT model was only trained "
                         "up to sequence length %d" % (FLAGS.max_seq_length, bert_config.max_position_embeddings))
